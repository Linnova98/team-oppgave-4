...
function render() {
  app.innerHTML = `
    ...
    <svg class="board span-2" viewBox="0 0 800 800">
		<image href="rockpaperscissorslizardspock_newthumb.png"/>
    ...
    <input type="text" onchange="playerName = this.value;" placeholder="Player name" value="${
...
function play(index) {
  ...
  applyResult();
  console.info(
    `${playerName} played "${names[index]}" and ${botName} played "${names[botIndex]}".`
  );
